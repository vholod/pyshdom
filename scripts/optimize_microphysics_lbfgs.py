...
class OptimizationScript(ExtinctionOptimizationScript):
    ...
    def get_summary_writer(self, measurements, ground_truth):
        ...
        if self.args.log is not None:
            ...
            writer.monitor_scatterer_slices(estimator_name=self.scatterer_name, ground_truth=ground_truth)
            ...
            writer.monitor_scatter_plot(estimator_name=self.scatterer_name, ground_truth=ground_truth, dilute_percent=0.4, parameters=['reff'])
