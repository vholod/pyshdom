...
from vadim.CloudCT_Utils import *
from scripts.render_radiance_toa import *
...
#view_zenith_list =[45.6, 0.0, -45.6, -70.5] #5 cameras
view_zenith_list = [-25.0]


view_azimuth_list =[90]

wavelengths_list = [[0.555],[1.6]]

# Solar parameters
solar_azimuth = [0.0]#, 22.5, 45, 67.5, 90]
solar_zenith = [180]#165
