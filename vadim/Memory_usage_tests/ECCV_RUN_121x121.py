...
"""
old runs were with:
NSHF_LIST = [5.0,    4.28,    3.57,    2.86,   2.14,    1.43,    0.72,    0.01]
AGF_LIST = [5.0,    4.44,    3.88,    3.32,    2.77,    2.21,    1.65,    1.10]
"""
#I need to reru it since I forgot to copy the log:
# I have the NSHF_LIST = 5.0, AGF_LIST = 5.0 finished for all the angular resolution.
# I have the NSHF_LIST = 5.0, AGF_LIST = 3.0 finished for all the angular resolution.

#NSHF_LIST = [5.0,    4.28,    2.5,     0.5,    0.01]
#AGF_LIST = [5.0,    3,    2.5,    2.0,    1.65,    1.10]


#NSHF_LIST = [2,    0.72,    0.01] # don't use small value of NSHF,  RADIANCE_TRUNCATION: Really out of memory for more radiance terms.
#AGF_LIST = [  2.77,   1.65,    1.10]

NSHF_LIST = [1.1, 1.5] # don't use small value of NSHF,  RADIANCE_TRUNCATION: Really out of memory for more radiance terms.
AGF_LIST = [2, 1.65, 1.10]
                    ...
                    for fx,fy,fz,origin,fov,lookat in zip(fx_list,fy_list,fz_list,origin_list,fov_list,lookat_list):
                        ...
                        for num_mu,num_phi in zip(num_mu_list,num_phi_list):
                            ...
                            if os.path.exists(output_dir):
                                print("you want to run\n {}".format(this_name))
                                print('This run is already exists!, skip it\n')
